...
import { getDeferredInstallPrompt, onInstallPromptAvailable, isStandaloneDisplay, isIOSDevice } from '../../lib/installPrompt.js'
...
export default function OnboardingPrompt() {
    ...
    return (
        <Modal isOpen onClose={finish} title={step === 'install' ? 'Instalar Refugio App' : 'Notificaciones'} size="sm">
            {step === 'install' && (
                installPrompt ? (
